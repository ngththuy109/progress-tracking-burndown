...
| 7a2 | **US-10** Lọc theo loại lỗi | Mở ô lọc **Problem** (và thử ô **Epic**) | Ô **Problem** liệt kê các loại lỗi **đang có ticket** kèm số lượng; tích nhiều loại cùng lúc thì bảng gộp ticket của các loại đã chọn. Cả ba ô **Epic / PIC / Problem** đều cho chọn **nhiều** giá trị một lúc | ☐ |
