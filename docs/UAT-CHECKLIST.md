...
| 7a1 | **US-10** Giao việc sửa dữ liệu | Mở *Monitoring* → *Data quality* → **Show ticket details**, mở ô lọc **PIC** | Bảng có cột **PIC**; tích **một** người thì chỉ còn ticket của người đó, tích **thêm** người nữa thì gộp cả nhóm (lọc hàng loạt), nút tải CSV đổi theo số dòng đang thấy; tích **No PIC yet** ra đúng ticket chưa gán ai; nút **Clear** đưa về tất cả | ☐ |
| 7a2 | **US-10** Lọc theo loại lỗi | Mở ô lọc **Problem** (và thử ô **Epic**) | Ô **Problem** liệt kê **đủ cả sáu** loại lỗi kèm số ticket (kể cả loại đang **0**); tích nhiều loại cùng lúc thì bảng gộp ticket của các loại đã chọn. Cả ba ô **Epic / PIC / Problem** đều cho chọn **nhiều** giá trị một lúc | ☐ |
