...
3. **Thanh tóm tắt / chú giải khớp bảng màu mới.** Chip số đếm ở thanh tóm tắt bỏ badge sắc thái cũ (xanh lá/hổ phách nhạt), chuyển sang `.signboard__count[data-status]` **dùng chung đúng bộ màu solid với ô** (một nguồn màu duy nhất trong CSS, không lệch được). NYS/NO_PLAN giữ chip nhạt vì ô của chúng cũng không tô đặc.
